...
from adversarial_training_toolkit.defense.feature_scatter.fs_attack_methods import (
    Attack_FeaScatter,
)
...
def train_fun(epoch, net, trainloader, optimizer):
    print("\nEpoch: %d" % epoch)
    net.train()
...
def main_featurescatter(ds_name):
    ...
    for epoch in range(1, args.max_epoch):
        train_fun(epoch, net, trainloader, optimizer)
